...
Use Copilot to research topics, gather information across multiple sources (documents, web, emails, meetings), and
synthesize findings into actionable summaries. This pattern turns scattered information into structured, decision-ready
outputs.
