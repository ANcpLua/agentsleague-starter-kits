...
Create formal documents (RFPs, FAQs, best practice guides, IT documentation) using Copilot in Word or Office Agent,
often referencing existing templates and multiple source files. This pattern accelerates the drafting process by
combining multiple inputs into a cohesive document.
