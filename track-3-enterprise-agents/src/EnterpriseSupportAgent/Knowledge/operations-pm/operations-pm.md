...
Cassandra uses Copilot to summarize her emails and Teams messages from overnight and draft responses to urgent items
leveraging the drafting feature.
...
To make sure she is ready for her meeting, she uses Copilot to search for information on the project looking across past
emails, meetings, files, internal and external articles.
...
To focus on the meeting instead of taking notes, Cassandra uses the transcribe feature during the project team meeting
to capture a summary of the conversation and key actions.
...
Following the meeting, she utilizes Agent Mode in Excel to review and analyze the project data and generate reports. She
shares key insights and meeting actions to all the attendees.
...
Cassandra joins her colleagues to brainstorm the change management and readiness plan for an upcoming project using
Copilot in Whiteboard to capture key project needs.
...
Cassandra prepares a PowerPoint presentation on the readiness plan, using Office Agent to generate the content based on
