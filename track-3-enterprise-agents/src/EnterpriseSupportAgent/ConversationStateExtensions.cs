...
{
    private static List<StoredChatMessage> GetConversationHistory(this ConversationState state)
    {
    ...
    private static void SetConversationHistory(this ConversationState state, List<StoredChatMessage> messages)
    {
